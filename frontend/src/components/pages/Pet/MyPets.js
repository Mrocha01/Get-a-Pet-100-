                    ...
                    {pet.available ? (
                        ...
                        {pet.adopter && (
                            ...
                            <button className={styles.remove_btn}
                                onClick={() => removeSchedule(pet._id)}>
                        ...
                        <p className={styles.boldG}>Este Pet foi adotado!</p>
                    )}
                    </div>
                </div>
                ))
            ) : (
                <p>Não há Pets cadastrados! <Link to={"/pet/add"}>Cadastre o seu primeiro Pet</Link></p>
            )
            }
            </div>
        </section>
